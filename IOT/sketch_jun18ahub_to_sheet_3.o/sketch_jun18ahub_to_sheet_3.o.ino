...
const char* ssid = "AAAAAAA";//Put the wifi name
const char* password = "AAAAAAAA";//Put the wifi password
const char* scriptUrl = ".........";// put the script code copied from app script during Gsheet extension implementation
...
uint8_t nodeMac[] = {0xbc, 0xdd, 0xc2, 0xcc, 0x71, 0x28};//Put node mac address
...
<title>Machine Health Live Dashboard</title>
<script src='https://cdn.jsdelivr.net/npm/chart.js'></script>
<a href="http://192.168.224.93:5000" style=" 
